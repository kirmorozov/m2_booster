...
string',
    ...
    {
        $builder = $this->getMockBuilder(\Magento\Framework\DataObject::class);
        $mock = $builder->addMethods(['setTestData', 'getTestData'])->getMock();
        // $mock = $this->createStub(\Magento\Framework\DataObject::class, ['setTestData', 'getTestData']);
...
';
     ...
     *
     * @__expectedException \Magento\Framework\Exception\LocalizedException
     */
